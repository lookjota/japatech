...
function Shell() { return <div className="japa-app"><a className="skip-link" href="#conteudo-principal">Ir para o conteúdo principal</a><Header /><Analytics /><Routes><Route path="/__design-system" element={<TechnicalPreview />} /><Route path="/" element={<HomePage page={homePage} />} /><Route path="/assistencia-tecnica" element={<AssistanceHubPage page={publicRoutes.find(({ pathname }) => pathname === '/assistencia-tecnica')!.page} />} /><Route path={serviceVerticals.notebook.route} element={<ServiceVerticalPage page={publicRoutes.find(({ pathname }) => pathname === serviceVerticals.notebook.route)!.page} vertical={serviceVerticals.notebook} />} /><Route path={serviceVerticals.computador.route} element={<ServiceVerticalPage page={publicRoutes.find(({ pathname }) => pathname === serviceVerticals.computador.route)!.page} vertical={serviceVerticals.computador} />} /><Route path={serviceVerticals.monitor.route} element={<ServiceVerticalPage page={publicRoutes.find(({ pathname }) => pathname === serviceVerticals.monitor.route)!.page} vertical={serviceVerticals.monitor} />} /><Route path={serviceVerticals.audio.route} element={<ServiceVerticalPage page={publicRoutes.find(({ pathname }) => pathname === serviceVerticals.audio.route)!.page} vertical={serviceVerticals.audio} />} />{publicRoutes.filter(({ pathname }) => pathname !== '/' && pathname !== '/assistencia-tecnica' && pathname !== '/assistencia-tecnica/tv' && !Object.values(serviceVerticals).some((vertical) => vertical.route === pathname)).map(({ pathname, page }) => <Route key={pathname} path={pathname} element={<PageView page={page} />} />)}<Route path="/assistencia-tecnica/tv" element={<TvLandingPage page={publicRoutes.find(({ pathname }) => pathname === '/assistencia-tecnica/tv')!.page} />} /><Route path="*" element={<PageView page={notFoundPage} />} /></Routes><Footer /></div> }
